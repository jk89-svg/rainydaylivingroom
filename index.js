...
#gameLeftCol{display:flex;flex-direction:column;flex-shrink:0;}
.ingame-logo-img{display:block;width:130px;max-width:100%;height:auto;margin:0 0 6px 2px;cursor:pointer;}
...
@media(max-width:600px){
  ...
  .ingame-logo-img{width:85px!important;}
}
